...
namespace CNA_SalesWebMvc.Models
{
    public class Seller
    {
        ...
        [DisplayFormat(DataFormatString = "{0:dd/MM/yyyy}")] // altera o formato de como a data é mostrada
        public DateTime BirthDate { get; set; }

        [Required(ErrorMessage = "{0} required")]
        [Range(100.0, 50000.0, ErrorMessage = "{0} must be from {1} to {2}")] // o salário minimo 100 e max 50mil
