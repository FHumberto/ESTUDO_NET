...
partial class FrmSetores
{
    ...
    private void InitializeComponent()
    {
        ...
        DataGridSetores.Dock = DockStyle.Fill;
        DataGridSetores.Location = new Point(0, 25);
        DataGridSetores.Name = "DataGridSetores";
        DataGridSetores.ReadOnly = true;
        DataGridSetores.RowTemplate.Height = 25;
        DataGridSetores.Size = new Size(800, 425);
